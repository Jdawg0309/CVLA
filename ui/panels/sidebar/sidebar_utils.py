...
def _section(self, title, icon="", default_open=True):
    ...
    imgui.push_style_color(imgui.COLOR_HEADER, 0.18, 0.18, 0.2, 0.9)
    imgui.push_style_color(imgui.COLOR_HEADER_HOVERED, 0.22, 0.22, 0.26, 0.95)
    imgui.push_style_color(imgui.COLOR_HEADER_ACTIVE, 0.26, 0.26, 0.3, 1.0)
